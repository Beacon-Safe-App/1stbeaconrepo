 ...
 * @desc Logs out a user by clearing the session cookie
 * @access Private
 */
export async function Logout(req, res) {
    try {
      // Assuming the session cookie name is "SessionID"
      res.clearCookie("SessionID"); 
  
      // Optionally, add logic to blacklist the token
      // This would prevent further use of the token even if intercepted.
      // ... Blacklist logic using Blacklist model ... 
